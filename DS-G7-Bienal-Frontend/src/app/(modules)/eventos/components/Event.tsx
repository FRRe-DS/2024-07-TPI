...
export function Event({ evento, index }: { evento: Evento; index: number }) {
  return (
    <article key={index} className="group relative m-4 p-6 cursor-pointer rounded-lg bg-white shadow-md transition-all duration-300 hover:shadow-lg z-0 overflow-hidden">
